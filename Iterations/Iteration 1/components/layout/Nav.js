					...
					<div class="navbar-header">
				 	...
				 	<div class={"navbar-collapse " + navClass} id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							...
							<li class={location.pathname.indexOf("/archives") === 0 ? "active" : ""} onClick={this.collapse.bind(this)}>
								<Link activeClassName="active" to="archives">Archives</Link>
							</li>
							<li class={location.pathname.indexOf("/settings") === 0 ? "active" : ""} onClick={this.collapse.bind(this)}>
